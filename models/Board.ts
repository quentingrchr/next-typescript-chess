...
export class Board implements IBoard {
  ...
  setBoard() {
    ...
    this.createPiece(new Knight(ColorType.WHITE), [1, 0])
    this.createPiece(new Knight(ColorType.WHITE), [6, 0])
    this.createPiece(new Bishop(ColorType.WHITE), [2, 0])
    this.createPiece(new Bishop(ColorType.WHITE), [5, 0])
    ...
    this.createPiece(new Knight(ColorType.BLACK), [1, 7])
    this.createPiece(new Knight(ColorType.BLACK), [6, 7])
    this.createPiece(new Bishop(ColorType.BLACK), [2, 7])
    this.createPiece(new Bishop(ColorType.BLACK), [5, 7])
  }
